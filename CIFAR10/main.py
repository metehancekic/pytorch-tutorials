...
def main():
    ...
    elif args.model == "ConvolutionalAttentionResNet":
        model = ConvolutionalAttentionResNet().to(device)
    elif args.model == "SpatialAttentionResNet":
        model = SpatialAttentionResNet().to(device)
    elif args.model == "ConvolutionalSpatialAttentionResNet":
        model = ConvolutionalSpatialAttentionResNet().to(device)
    else:
