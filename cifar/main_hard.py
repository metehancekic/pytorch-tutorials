...
python -m pytorch-tutorials.cifar.main_hard --model ResNetEmbedding --epochs 100 -tr -sm
...
def main():
    ...
    lr_steps = args.epochs * len(hard_loader)
    ...
    if args.train:
        ...
        if args.save_model:
            ...
            torch.save(model.state_dict(), args.directory +
                       "checkpoints/" + "secondary_" + checkpoint_name)
