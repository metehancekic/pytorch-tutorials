...
def get_arguments():
    ...
    # Directory
    parser.add_argument("--directory", type=str, default="/home/metehan/pytorch-tutorials/mnist/",
                        metavar="", help="Directory of experiments",
                        )
    parser.add_argument('--dataset', type=str, default='mnist',
                        metavar='mnist/fashion', help='Which dataset to use (default: mnist)')

    neural_net = parser.add_argument_group("neural_net", "Neural Network arguments")

    # Neural Model
    neural_net.add_argument("--model", type=str, default="LeNet", metavar="Neural-architecture",
    ...
    # Optimizer
    neural_net.add_argument("--lr", type=float, default=0.01, metavar="LR", help="Learning rate",
                            )
    neural_net.add_argument("--lr_min", type=float, default=0., metavar="LR",
                            help="Learning rate min",
                            )
    neural_net.add_argument("--lr_max", type=float, default=0.01, metavar="LR",
    ...
    neural_net.add_argument("--test_batch_size", type=int, default=10000, metavar="N",
    ...
    adv_training.add_argument("-tr_eps", "--tr_epsilon", type=float, default=0.3,
    ...
    adv_training.add_argument("-tr_Ss", "--tr_step_size", type=float, default=0.01,
    ...
    adv_testing.add_argument("-eps", "--epsilon", type=float, default=0.3, metavar="",
                             help="attack budget",
                             )
    adv_training.add_argument("-a", "--alpha", type=float, default=0.375,
                              metavar="", help="random fgsm budget",
                              )
    adv_testing.add_argument("-Ss", "--step_size", type=float, default=0.01, metavar="",
                             help="Step size for PGD",
                             )
    adv_testing.add_argument("-Ni", "--num_iterations", type=int, default=100, metavar="",
